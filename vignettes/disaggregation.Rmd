...
values(r) <- sapply(seq(terra::ncell(r)), function(x) rnorm(1, ifelse(x %% n_pixels_x != 0, x %% n_pixels_x, n_pixels_x), 3))
r2 <- terra::rast(ncol = n_pixels_x, nrow = n_pixels_y)
terra::ext(r2) <- terra::ext(df)
values(r2) <- sapply(seq(terra::ncell(r)), function(x) rnorm(1, ceiling(x/n_pixels_y), 3))
